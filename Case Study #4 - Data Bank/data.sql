...
VALUES
  ...
  ('500', '2', '2', '2020-04-15', '9999-12-31'))as temp(customer_id, region_id, node_id, start_date, end_date);
...
VALUES
  ...
  ('189', '2020-01-27', 'withdrawal', '861'))as temp(customer_id, txn_date, txn_type, txn_amount);